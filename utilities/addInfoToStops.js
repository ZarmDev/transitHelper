...
export async function addTrainLinesToStopsFile() {
    ...
    fs.writeFile('./assets/trains/google_transit/needsattention.txt', "FAILED STOPS. You can either ignore it or fix it by modifying stops.txt or modifying the files in the routes folder!\n" + whatToFix.join('\n'))
